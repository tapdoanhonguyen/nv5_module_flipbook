        ...
        if ($nv_Request->isset_request('save', 'post')) {
            ...
            if (isset($post['id'])) {
                ...
                $query = "INSERT INTO " . NV_PREFIXLANG . "_" . $module_data . "_row
                    (id, replacement, relatement, title, alias, code, cid, sid, eid, sgid, keywords, groups_view, groups_download, files, image, status, approval, addtime, edittime, publtime, start_comm_time, end_comm_time, startvalid, exptime, view_hits, download_hits, admin_add, admin_edit)
                VALUES
                    (NULL,
