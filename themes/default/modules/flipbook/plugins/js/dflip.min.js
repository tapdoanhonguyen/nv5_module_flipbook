 ...
 */
"use strict";
var url_path =  "/nukeviet/themes/default/modules/flipbook/plugins";
var DFLIP = DFLIP || {}, PRESENTATION = DFLIP;
...
!function(e, t) {
    ...
    var n, i, o, a, s = e.defaults = {
        ...
        pdfjsSrc:  url_path + "/js/libs/pdf.min.js",
        pdfjsCompatibilitySrc: url_path +  "/libs/compatibility.js",
        pdfjsWorkerSrc:  url_path + "/js/libs/pdf.worker.min.js",
        threejsSrc: url_path + "/js/libs/three.min.js",
        mockupjsSrc:  url_path + "/js/libs/mockup.min.js",
        soundFile:  url_path + "/sound/turn2.mp3",
        imagesLocation: "images",
        imageResourcesPath:  url_path + "/images/pdfjs/",
        cMapUrl: "cmaps/",
        enableDebugLog: !1,
        canvasToBlob: !1,
        enableAnnotation: !0,
    ...
    d.rotateStr), P = (d.bg,
    d.bgImage), x = (d.src,
    d.limitAt), y = d.distOrigin, C = d.distPoints, L = d.angleByDistance, S = d.log, I = d.nearestPowerOfTwo, E = d.extendOptions, k = d.getBasePage, T = d.getScript, O = d.fixMouseEvent, R = d.prefix, F = d.isBookletMode, M = d.isRTLMode, D = d.isMobile, N = d.hasWebgl, z = d.isSafari, B = d.isIOS, _ = d.__extends;
    !function() {
        ...
        return i.prototype = {
            ...
            resize: function() {
                ...
                if (null != n.target && null != n.target.ui && null != n.target.contentProvider && null != n.target.contentProvider.viewport && null != n.target.stage) {
                    ...
                    N = B = w ? n.calculateSize(N, F + P, D, O, R, w, m, C).stageHeight : z.stageHeight,
                    h.height(N);
                    var B = N
                      , _ = F - R
                      , A = B - O;
                    if (a = Math.floor(C ? _ : _ / 2),
        ...
        i.prototype.getPage = function(n, i, o) {
            ...
            l.getPage(r, o).then((function(t) {
                !function(t, n, i, o) {
                    ...
                    "css" == a.targetObject.mode && Math.abs(a.targetObject.zoomHeight - u.height) < 2 && Math.abs(a.targetObject.zoomWidth - u.width) < 2 && (u.height = a.targetObject.zoomHeight + 0,
    ...
    e(document).ready((function() {
        ...
        "undefined" != typeof dFlipWPGlobal)) {
            if (void 0 !== dFlipWPGlobal.pdfVersion) {
                ...
                "default" !== i && (DFLIP.defaults.pdfjsSrc = dFlipLocation + "js/libs/pdfjs/" + i + "/pdf.min.js",
                DFLIP.defaults.pdfjsWorkerSrc = dFlipLocation + "js/libs/pdfjs/" + i + "/pdf.worker.min.js")
            }
            n(dFlipWPGlobal),
        ...
        if (Array.prototype.forEach.call(DFLIP.utils.getSharePrefixes(), (function(t) {
            if (DFLIP.preParseHash && DFLIP.preParseHash.indexOf(t) >= 0 && !1 === o) {
                var n, i = DFLIP.preParseHash.split(t)[1].split("/")[0], a = DFLIP.preParseHash.split(t)[1].split("/")[1];
                null != a && (a = a.split("/")[0]),
                0 === (n = e("[slug=" + i + "]")).length && (n = e("#" + i)),
                0 === n.length && (n = e("[_slug=" + i + "]")),
                n.length > 0 && (null != a && n.data("page", a),
                n.is("._df_button, ._df_thumb, ._df_custom") && (n.trigger("click"),
                o = !0))
            }
        }
        )),
        ...
        t.on("click", ".dflip-books .df-more-button", (function() {
            ...
            if (t.length > 0) {
                ...
                t.find("._df_button, ._df_thumb, ._df_custom, ._df_book").each((function() {
                    "true" === e(this).attr("skip-parse") && (n < DFLIP.defaults.loadMoreCount && e(this).removeAttr("skip-parse"),
                    n++)
                }
                )),
                DFLIP.parseBooks()
