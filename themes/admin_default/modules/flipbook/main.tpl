                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="vertical-align: top">{LANG.fileupload}</td>
                                <td>
                                    <div id="filearea">
                                        <!-- BEGIN: files -->
                            ...
                            <tr>
                                <td class="text-left">{LANG.image}</td>
                                <td>
                                    <input class="w300 form-control pull-left" type="text" name="image" id="image-flipbook" value="{DATA.image}" style="margin-right: 5px"/>
                                    <input type="button" value="Browse server" id="browser-image" class="btn btn-info"/>
                                </td>
                            </tr>
                            <!-- BEGIN: comment -->
